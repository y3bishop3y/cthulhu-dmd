...
# Constants
DEFAULT_PSM_MODE: Final[int] = 3  # Fully automatic page segmentation
DEFAULT_OEM_MODE: Final[int] = 3  # Default OCR engine mode


def preprocess_image_for_ocr(image_path: Path) -> np.ndarray:
    """Preprocess image to improve OCR accuracy.
    
    This function applies a standard preprocessing pipeline:
    1. Convert to grayscale
    2. Apply thresholding (OTSU)
    3. Denoise
