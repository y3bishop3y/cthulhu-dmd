    ...
    for contour in contours:
        ...
        if 50 < area < 500:
            ...
            if 0.5 < aspect_ratio < 2.0:  # Roughly square/circular
                ...
                if (img_width * 0.1 < x < img_width * 0.9 and
                    img_height * 0.2 < y < img_height * 0.9):
                    dice_count += 1
    ...
    for contour in contours:
        ...
        if 100 < area < 2000:
            ...
            if 0.6 < aspect_ratio < 1.5:  # Roughly circular
                ...
                if (img_width * 0.1 < x < img_width * 0.9 and
                    img_height * 0.05 < y < img_height * 0.4):  # Top portion (insanity track)
                    swirl_count += 1
...
if __name__ == "__main__":
    ...
    if test_path.exists():
        ...
        print(f"Red swirls found: {results['red_swirl_found']} (count: {results['red_swirl_count']})")
        print("=" * 80)
    else:
