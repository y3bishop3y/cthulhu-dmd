...
try:
    ...
    print(
        ...
        "  1. uv run python scripts/parsing/parse_special_powers.py [options]\n"
        "  2. source .venv/bin/activate && python scripts/parsing/parse_special_powers.py [options]\n\n"
        "Recommended: uv run python scripts/parsing/parse_special_powers.py --help\n",
        file=sys.stderr,
    )
    sys.exit(1)
