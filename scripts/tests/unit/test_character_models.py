...
class TestCommonPower:
    ...
    def test_from_dict_with_levels(self):
        ...
        assert power.levels[0].description == "When making any roll, you may count 1 Arcane as a success."
    ...
    def test_round_trip_serialization(self):
        ...
        assert round_trip_data["levels"][0]["description"] == original_data["levels"][0]["description"]
        assert round_trip_data["levels"][0]["effect"] == original_data["levels"][0]["effect"]
        assert round_trip_data["levels"][0]["statistics"]["green_dice_added"] == original_data["levels"][0]["statistics"]["green_dice_added"]
