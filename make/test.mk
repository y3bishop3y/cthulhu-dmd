...
test-unit:
	...
	uv run pytest scripts/tests/unit/ -v

# Run integration tests only
test-integration:
	@echo "Running integration tests..."
	uv run pytest scripts/tests/integration/ -v

# Run tests with coverage
test-cov:
	@echo "Running tests with coverage..."
	uv run pytest scripts/tests/ -v --cov=scripts --cov-report=term-missing --cov-report=html
