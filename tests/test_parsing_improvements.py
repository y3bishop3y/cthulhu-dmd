...
try:
    ...
    from scripts.core.parsing.text import (
        clean_ocr_text,
...
def test_elder_sign_parsing():
    ...
    for desc in test_descriptions:
        ...
        count_str = (
            str(elder.elder_signs_as_successes) if elder.elder_signs_as_successes < 999 else "any"
        )
        table.add_row(
            desc,
            count_str,
...
def test_power_level_analysis():
    ...
    test_powers = [
        ...
        (
            "Arcane Mastery",
            1,
            "When making any roll, you may count 1 Arcane (elder sign) as a success.",
        ),
