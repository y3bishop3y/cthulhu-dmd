...
from scripts.cli.tools.nlp_analysis import compare_semantic_info, extract_semantic_info
...
class TestSemanticComparison:
    ...
    def test_compare_verbs(self):
        ...
        gt_info = {"verbs": ["heal", "reduce"]}

        ocr_info = {"verbs": ["heal", "attack", "move"]}
